// main.js - Enhanced Trading Bot Entry Point (ES Module)

import dotenv from "dotenv";
import streamEnhanced from "./stream-enhanced.js";
import RiskManager from "./riskmanager.js";
import * as advancedlogic from "./advancedlogic.js";
...
function displayStartupInfo() {
    ...
    console.log(`  Pattern Recognition:  ${config.enableAdvancedPatterns}`);
    console.log(`  Self-Improvement:     ${config.enableSelfImprovement}`);
    console.log(`  Risk Management:      ${config.enableRiskManagement}`);
    ...
    console.log("────────────────────────────────────────────────────────────");
    for (const [tf, settings] of Object.entries(config.timeframes)) {
...
export default { riskManager, advancedlogic, streamEnhanced };
